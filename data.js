const products = [
    ...
    { id: "FL001", name: "Classic Rose", category: "Artificial Flowers & Leafs", price: "Premium", stock: "Available", image: "https://images.unsplash.com/photo-1560790671-b76ca4de55ef?auto=format&fit=crop&q=80&w=800", description: "Colors: Yellow, White, Pink, Blue, Orange, Purple", colors: ["Multiple"] },
    { id: "FL002", name: "Berry Dahlia", category: "Artificial Flowers & Leafs", price: "Premium", stock: "Available", image: "https://images.unsplash.com/photo-1560790671-b76ca4de55ef?auto=format&fit=crop&q=80&w=800", description: "Colors: Yellow, Blue, Red, Pink, Purple, White", colors: ["Multiple"] },
    { id: "FL003", name: "Dutch Cabbage", category: "Artificial Flowers & Leafs", price: "Premium", stock: "Available", image: "https://images.unsplash.com/photo-1560790671-b76ca4de55ef?auto=format&fit=crop&q=80&w=800", description: "Colors: Red, Pink, Silver White, White, Orange, Light Pink", colors: ["Multiple"] },
